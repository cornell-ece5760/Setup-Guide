...
[Git](https://git-scm.com/) is an very popular tool for [software version control](https://en.wikipedia.org/wiki/Version_control). We primarily use it to track your work, ensuring that as you make incremental changes to files, you will always be able to revert to, see, and combine old versions. When combined with a remote repository (in our case GitHub), it also ensures that you have an online backup of your work. Git is also a very effective way for multiple people to work together: collaborators can upload their work to a shared repository. (It certainly beats emailing versions back and forth.) - [CS 3410](https://www.cs.cornell.edu/courses/cs3410/2025fa/rsrc/git.html)
...
# Required Languages
Students should have a relatively concrete understanding of the following
programming and hardware description languages to do well in this course:
